...
declare function app:sidebyside($node as node(), $model as map(*), $fileNum as xs:integer?, $documentId as xs:string?, $runId as xs:string?, $classifier as xs:string) {
 ...
 let $examplefile := "/db/laceData/894469813v1/2017-06-30-09-00_bude-2017-06-15-13-39-00040500.pyrnn.gz_selected_hocr_output/894469813v1_0031.html"
 ...
 let $imageFile := concat('/exist/rest',$app:imageDataPath,$documentId,"/",$documentId,"_",$fileNumFormat,".jpg")
 let $paramsWithoutFileNum := concat("?documentId=",$documentId,"&amp;runId=",$runId,"&amp;classifier=",$classifier,"&amp;fileNum=")
  ...
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="{concat($paramsWithoutFileNum,$previousFileNum)}" tabindex="-1">Previously</a>
    </li>
