...
function generate_image_tag_call(book_name, page_file, bbox) {
    ...
    //page_file = "490021999brucerob_0100.jpg"
        var request = "<img src=\"" + "http://heml.mta.ca/lace" + "/image_test?book=" + encodeURIComponent(book_name) + "&amp;file=" + encodeURIComponent(page_file) + "&amp;bbox=" + encodeURIComponent(bbox) + "\" alt='a word image'/>"
        //console.log(request);
	return request
}
